...
import { allMentors, createAccount, createOrder, forgotPassword, mentorAcademicDetails, mentorDetails, mentorLogin, mentorLogout, removeMentorIfNotVerified, resendOtp, resetPassword, singleMentor, verifyOTP, verifyPayment } from '../controllers/mentor.controller.js'
...
router.route('/all-mentors').post(allMentors)
