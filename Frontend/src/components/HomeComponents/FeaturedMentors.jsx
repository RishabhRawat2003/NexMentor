...
function FeaturedMentors() {
    ...
    return (
        <div className='w-full h-auto flex flex-col my-10 px-2'>
            ...
            <div className='w-f h-auto flex flex-col mt-5 md:mt-10 justify-center items-center'>
                <NavLink to='/search-mentor' className='border border-[#0092DB] text-[#0092DB] px-6 py-2 rounded-md'>Browse All Mentors</NavLink>
            </div>
        </div>
    )
}
