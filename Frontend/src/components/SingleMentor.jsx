  ...
  return (
    <>
      {loading
        ? <Loading />
        : (
          <div className='w-full h-auto flex flex-col py-3 gap-8'>
            <div className='w-full h-auto flex flex-col md:flex-row md:justify-between md:px-3 lg:px-20 2xl:px-32 gap-7'>
              <div className='w-full h-auto flex shadow-custom  lg:shadow-gray-300 mx-auto md:flex-col md:w-[30vw] md:mx-0 md:h-[50vh] lg:w-[25vw] lg:h-[55vh] xl:w-[20vw] 2xl:w-[20vw] md:rounded-lg'>
                ...
                <div className='w-full h-auto flex flex-col p-2 font-cg-times justify-between md:h-full'>
                  ...
                  <div className='w-full h-auto bg-[#0092DB] flex justify-center items-center text-white py-1 mt-2 cursor-pointer md:py-1.5 md:hover:bg-[#0092dbb6] active:bg-[#0092dbb6] rounded-sm'>Book Session</div>
                </div>
              </div>
              <div className='w-full h-auto flex justify-center items-center md:w-[60vw] lg:w-[70vw] '>
                <img src="" alt="" className='w-[90%] h-[25vh] bg-gray-400 rounded-xl sm:h-[40vh] lg:h-[55vh]' />
              </div>
            </div>
            ...
            <div className='w-[90%] mx-auto rounded-md h-auto flex flex-col shadow-custom p-4 gap-5'>
              <h1 className='text-center font-cg-times md:text-lg xl:text-2xl'>Packages</h1>
              <div className='w-full h-auto flex flex-col justify-center items-center py-5 xl:py-10'>
                {
